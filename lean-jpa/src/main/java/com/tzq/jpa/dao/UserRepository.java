...
public interface UserRepository extends JpaRepository<User, Integer>, JpaSpecificationExecutor<User> {
     ...
     * @return
     */
    @Query(value = "DELETE FROM t_user WHERE user_id IN (:userList)", nativeQuery = true)
    @Modifying
    @Transactional
     ...
     * @return
     */
    @Query(value = "SELECT role_id FROM t_user_role WHERE 1=1 AND user_id=:usersId ", nativeQuery = true)
